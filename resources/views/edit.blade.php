...
<div class="container">
  ...
  <form action="{{route('tasks.update',$editModel->id)}}" method="post">
    @csrf
    @method('PUT')
    <div class="form-group">
      <label for="name">Name:</label>
      <input type="text" class="form-control" id="name" placeholder="Enter Name" name="name" value="{{$editModel->name}}">
    </div>
    <div class="form-group">
      <label for="taskname">Task Name:</label>
      <input type="taskname" class="form-control" id="task_name" placeholder="Enter Task Name" name="task_name" value="{{$editModel->task_name}}">
    </div>
    <div class="form-group">
      <label for="datetime">Date & Time:</label>
     <input type="text" class="form-control datetimepicker" name="datetime" value="{{$editModel->datetime}}"> 
    </div>
